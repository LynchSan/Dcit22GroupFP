...
//CODE BY TAGC
//Source:https://gist.github.com/TAGC/fd071e21831a254fc420f977b35e8211

public static class snakeDesu
{
    public static async Task snakeGame()
    {
...
class Snake : IRenderable
{
    ...
    public void Render()
    {
        ...
        {
            Console.SetCursorPosition(segment.Left, segment.Top);
            Console.Write("■");
        }
    }
    ...
    private bool PositionIsValid(Position position)
    {
        return position.Top >= 0 && position.Left >= 0
            && position.Top < Console.WindowHeight
            && position.Left < Console.WindowWidth;
    }
}
